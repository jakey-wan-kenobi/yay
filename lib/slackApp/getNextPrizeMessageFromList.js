...
function getNextPrizeMessageFromList (products, index, recipientHandle) {
  ...
  // If this product is sold out, or there are no skus, skip it. Do this recursively until we reach a product that's available. TODO: This should be inside an async/await function, since this is recursive. We may end up proceeding on the wrong product accidentally.
